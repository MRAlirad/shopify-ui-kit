			...
			{(title || action || text) && (
				<div
					className={classNames({
						...
						"bg-blue-50 dark:bg-blue-900/20 px-6 py-4": blueTitleBg,
				...
				>
					<div className="grid grid-cols-[max-content_1fr] items-center gap-x-2 gap-y-1">
						...
						<h3 className="text-neutral-900 dark:text-white text-base font-bold">{title}</h3>
						{text && <p className="col-span-2 text-neutral-500 dark:text-neutral-400 text-xs line-clamp-1">{text}</p>}
					</div>
